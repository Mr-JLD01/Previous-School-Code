...
3/22/19
Computer Science I
This progrm sees the user input a number of rooms then the dimensions of the rooms and of the square tile to be used to floor said rooms. It outputs the number of boxes needed and how many extra tiles.
*/
